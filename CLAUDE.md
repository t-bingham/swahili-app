...
> Extends `~/.claude/CLAUDE.md` (global Karpathy principles: Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution). Those rules apply here in full.
